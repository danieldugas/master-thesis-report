...
% \centering
% \subfloat[]{
% \includegraphics[width=2.9in]{images/before_segmatch.pdf}
% \label{fig_online_before_optimization}}
% \hfil
% \subfloat[]{
% \includegraphics[width=3.2in]{images/after_segmatch.pdf}
% \label{fig_online_after_optimization}}
